...
config :livekit_course, LivekitCourseWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: LivekitCourseWeb.ErrorHTML, json: LivekitCourseWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: LivekitCourse.PubSub,
  live_view: [signing_salt: "ewqLnmSj"]
...
config :livekit_course, LivekitCourse.Mailer, adapter: Swoosh.Adapters.Local
