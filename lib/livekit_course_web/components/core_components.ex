defmodule LivekitCourseWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: LivekitCourseWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LivekitCourseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LivekitCourseWeb.Gettext, "errors", msg, opts)
    end
  end
